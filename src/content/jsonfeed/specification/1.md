...
<span id="byline">by <a href="https://inessential.com/">Brent Simmons</a> and <a href="https://manton.org/">Manton Reece</a></span>

The JSON Feed format is a pragmatic syndication format, like [RSS](https://cyber.harvard.edu/rss/rss.html) and [Atom](https://tools.ietf.org/html/rfc4287), but with one big difference: it’s JSON instead of XML.
...
(The authors thank [Craig Hockenberry](https://furbo.org/) for the icon.)
...
* [Shape Of](https://shapeof.com/feed.json)
* [Flying Meat](https://flyingmeat.com/blog/feed.json)
* [Maybe Pizza?](https://maybepizza.com/feed.json)
* [Daring Fireball](https://daringfireball.net/feeds/json)
* [Hypercritical](https://hypercritical.co/feeds/main.json)
...
* [Timetable](https://timetable.manton.org/feed.json) (podcast)
* [The Record](https://therecord.co/feed.json) (podcast)
* [Allen Pike](https://www.allenpike.com/feed.json)

In addition, this website has its own [JSON Feed](https://www.jsonfeed.org/feed.json).

## Reviewers

The authors thank the following people for their extensive contributions and review, in alphabetical order: [Allen Pike](https://www.steamclock.com/blog/), [Craig Hockenberry](https://furbo.org/), [Daniel Jalkut](https://bitsplitting.org/), [Gus Mueller](https://shapeof.com/), [Guy English](https://twitter.com/gte), [Jim Correia](https://twitter.com/jimcorreia), [Joe Heck](https://rhonabwy.com/), [John Gruber](https://daringfireball.net/), [John Siracusa](https://twitter.com/siracusa), [Laura Savino](https://twitter.com/savinola), [Marco Arment](https://marco.org/), and [Paul Kafasis](https://onefoottsunami.com/).

## See Also

[Mapping RSS and Atom to JSON Feed](/jsonfeed/mapping-to-jsonfeed/)
